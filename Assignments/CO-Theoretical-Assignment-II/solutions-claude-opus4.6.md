# Solutions — Computer Architecture Problems (RV32)
...
### 1.5(a): Which processor has the highest performance (instructions per second)?
...
### 1.5(b): Each processor executes a program in 10 seconds. Find cycles and instructions.
...
### 1.5(c): Reduce execution time by 30% with 20% CPI increase. What clock rate is needed?
...
**Calculate $151 + 214$ using unsigned 8-bit saturating arithmetic.**
$$
151 + 214 = 365
$$
...
**Multiply octal $62_8 \times 12_8$ (unsigned 6-bit) using Figure 3.3 hardware.**
...
**Divide octal $74_8$ by octal $21_8$ (unsigned 6-bit) using Figure 3.8 hardware.**
...
**What decimal number does $\texttt{0x0C000000}$ represent as two's complement and unsigned?**
...
## Question 6 (Textbook 3.23) — AI Critique

**Convert $63.25_{10}$ to IEEE 754 single-precision.**
...
$$
\text{sign} = 0, \quad \text{exponent} = 6 + 127 = 133 = 10000101_2
$$

$$
\text{fraction} = 11111101000000000000000
$$

$$
\text{IEEE 754: } 0 \;\; 10000101 \;\; 11111101000000000000000
$$
...
$$
63.25_{10} = 111111.01_2 \quad \text{(this part is correct)}
$$
...
Note: even given the AI's own stated mantissa $1.1111101_2$, the fraction should begin with $1111101$ (7 bits), not $11111101$ (8 bits). The fraction is **inconsistent with the AI's own normalization**.
